...
dependencies {
  compile 'com.github.blueapron:marinator:1.0.0'
  annotationProcessor 'com.github.blueapron:marinator-processor:1.0.0'

  // If using Kotlin:
  kapt 'com.github.blueapron:marinator-processor:1.0.0'
}
```
